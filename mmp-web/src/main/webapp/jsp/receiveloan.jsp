...
<div id="receiveloan" fit="true">
    <table id="rltbs" class="tabclass" style="width: auto; height: auto; " cellspacing="0" border="0">
        <tr>
            <td>借款状态：</td>
            <td><select class="easyui-combobox" id="rlstatus" name="status" style="width:100px;" onchange='getSubmitSatus()'>
            </select></td>
            <td>借款编号：</td>
            <td><input  id="rlcode" name="code"  value=""  style="width: auto;"></td>
            <td></td><td></td>
            <td></td><td></td>
        </tr>
        <tr>
            ...
            <td>付款单位：</td>
            <td><input  id="rlvendor" name="vendor"  value=""  style="width: auto;"></td>
            <td>支付日期：</td>
            <td>
        ...
        <tr>
            ...
            <td><button id="rlpay" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" onclick="rlpay()">付款</button></td>
        </tr>
    </table>
    <br>
...
//        $('#rldg').datagrid('reload')
    ...
    $(function(){
        ...
        $('#rldg').datagrid({
            ...
            queryParams:{status:$("#rlstatus").val()},
            pageSize:20,
            pageList:[10,20,30],
            fitColums:true,
            nowrap:true,
            ...
            columns:[[
                ...
                {field:"lastname",title:'收款单位（个人）',width:100,align:'center'},
                {field:"revendor",title:'收款单位',width:100,align:'center'},
                {field:"bank_account",title:'收款账号',width:100,align:'center'},
