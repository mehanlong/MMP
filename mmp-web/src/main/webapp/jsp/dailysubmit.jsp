...
<div id="dailysubmit" fit="true">
    <table id="dstbs" class="tabclass" style="width: auto; height: auto; " cellspacing="0" border="0">
        <tr>
            <td>报销状态：</td>
            <td><select class="easyui-combobox" id="dsstatus" name="status" style="width:100px;" onchange='getSubmitSatus()'>
            </select></td>
            <td>报销编号：</td>
            <td><input  id="dscode" name="code"  value=""  style="width: auto;"></td>
        ...
        <tr>
            ...
            <td>付款单位：</td>
            <td><input  id="dsvendor" name="vendor"  value=""  style="width: auto;"></td>
            <td>支付日期：</td>
            <td>
        ...
        <tr>
            ...
            <td><button id="dspay" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" onclick="dspay()">付款</button></td>
        </tr>
    </table>
    <br>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(function(){
        ...
        $('#dsdg').datagrid({
            ...
            queryParams:{status:$("#dsstatus").val()},
            pageSize:20,
            pageList:[10,20,30],
            fitColums:true,
            nowrap:true,
