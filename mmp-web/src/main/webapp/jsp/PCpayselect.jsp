...
<div id="pcbankselect" fit="true">
    <table id="pctbsbank" class="tabclass" style="width: auto; height: auto; " cellspacing="0" border="0">
        <tr>
        ...
        <tr>
            ...
            <td><button id="pcbksel" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" onclick="pcbksel()">确定</button></td>
        </tr>
    </table>
    <br>
...
//        $('#pcbkdgbank').datagrid({url:'/payregister/queryBankOption/'+new Date()});
        $('#pcbkdgbank').datagrid('clearSelections');
