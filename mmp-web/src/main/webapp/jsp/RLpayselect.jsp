...
<div id="rlbankselect" fit="true">
    <table id="rltbsbank" class="tabclass" style="width: auto; height: auto; " cellspacing="0" border="0">
        <tr>
        ...
        <tr>
            ...
            <td><button id="rlbksel" class="easyui-linkbutton" data-options="iconCls:'icon-edit'" onclick="rlbksel()">确定</button></td>
        </tr>
    </table>
    <br>
...
//        $('#rlbkdgbank').datagrid({url:'/payregister/queryBankOption/'+new Date()});
        $('#rlbkdgbank').datagrid('clearSelections');
