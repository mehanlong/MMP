...
//			httpClient.getConnectionManager().shutdown(); // 关闭连接,释放资源
    ...
    public static String sendCrmSSLPostRequest(String reqURL, String param, String authorization,String encodeCharset,
                                               String decodeCharset) {
        String responseContent = "";
//        HttpClient httpClient = new DefaultHttpClient();
//        HttpClient httpClient = QDClient.createDefaultClient();
        ...
        try {
            ...
            List<NameValuePair> params = new ArrayList<NameValuePair>();
            params.add(new BasicNameValuePair("q", param));
            httpPost.setEntity(new UrlEncodedFormEntity(params, "UTF-8"));
//            if (StringUtils.isNotEmpty(param)) {
//                httpPost.setEntity(new StringEntity(param,"UTF-8"));
//            }
